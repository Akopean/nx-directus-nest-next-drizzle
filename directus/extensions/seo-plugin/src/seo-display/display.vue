...
const seoValue = Array.isArray(props.value) ? props.value[0] : props.value;
const { state: titleState } = useSeoField(computed(() => seoValue?.title), seoRules.title);

const { state: descriptionState } = useSeoField(
	computed(() => seoValue?.meta_description),
	seoRules.meta_description
);
console.log('SEO Display Props:', titleState, seoValue.title, props.value?.title);
...
const status = computed(() => {
	console.log('SEO Display Status Props:', props);
		...
		<v-menu trigger="hover" :delay="300" show-arrow>
			...
			<div class="preview-box">
				...
				<SearchPreview
					...
					:meta-description="seoValue.meta_description"
